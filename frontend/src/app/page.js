  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-r from-orange-600 to-purple-600 text-white py-20">
          <Container maxWidth="lg">
            <div className="text-center">
              ...
              <Typography variant="h5" className="mb-8">
                Immerse yourself in worlds unknown, one page at a time.
              </Typography>
              <Link href='/store'>
                <Button variant="contained" size="large" className="bg-white text-orange-600 hover:bg-purple-500 hover:text-white">
                  Explore Books
                </Button>
              </Link>
            </div>
          ...
          <Grid container spacing={4}>
            ...
            <Grid item xs={12} sm={6} md={3}>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-blue-300">Order Status</a></li>
              </ul>
            </Grid>
            <Grid item xs={12} sm={6} md={3}>
              <Typography variant="h6" className="mb-4 font-semibold">
